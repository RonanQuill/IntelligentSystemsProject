...
public class fs17040434 {
    ...
    Stack<Node> ReconstructPath(Node endNode, Node startNode){
        ...
        while(currentNode != startNode) { //A simple address comparison is actually okay as the pointers will point to the same place if we arrive at the start node
